...
public class SchedulingTasksForFixedDelayRepeatedExecutionsUsingExecutors {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		ScheduledFuture<?> scheduledFuture1 = exeService.scheduleWithFixedDelay(new ScheduledTaskB(1000), 4, 2,
				TimeUnit.SECONDS);

		ScheduledFuture<?> scheduledFuture2 = exeService.scheduleWithFixedDelay(new ScheduledTaskB(3000), 4, 2,
				TimeUnit.SECONDS);
